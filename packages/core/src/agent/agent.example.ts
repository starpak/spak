...
async function example2_CreateAgentFromTemplate() {
  ...
  const templates = AgentTemplateManagerImpl.predefinedTemplates()
...
export {
  example1_CreateAgent,
  example2_CreateAgentFromTemplate,
  example3_ToolSystem,
  example4_ProviderSystem,
  example5_ManagementAndMonitoring
}
